...
export const coldEmailToHrGuide: Guide = {
  slug: 'cold-email-to-hr-for-internship',
  title: 'Cold Email to HR for an Internship: Templates and Rules That Get Replies',
  seoTitle: 'Cold Email to HR for Internship: Templates That Get Replies (India)',
  description:
    'Copy-paste cold email templates for internships in India, plus the subject lines, timing, and follow-up rules that take reply rates from 0% to 10-20%.',
  category: 'TEMPLATES',
  datePublished: '2026-06-12',
  dateModified: '2026-06-12',
  readMinutes: 8,
  md: String.raw`
Most cold emails from students get deleted in two seconds, and they all die the same way: too long, all about the sender, no specific ask. The fix is mechanical. Students running the format below, part of the system in our [off-campus internship playbook](/guides/how-to-get-an-off-campus-internship-in-india), regularly see 10-20% reply rates. Here is the entire method.
...
5. **Resume attached, named properly.** "Priya_Sharma_Marketing_Resume.pdf", not "resume_final_v3 (2).pdf". If you're not sure the resume itself is strong, [roast it for free](/resources/resume-roast) before you send a single email.
...
- **Track everything:** who, when, which template, follow-up date. By application 30 you cannot hold this in your head, and a missed follow-up is a lost offer. The [free Job Tracker](/job-tracker) does the reminders for you and can draft the outreach with AI.
...
Want the full library? 12 cold email templates, LinkedIn DM scripts, and the follow-up calendar pre-built: it's all in the [₹299 Career Toolkit](/resources/career-toolkit). Then find fresh companies worth emailing on the [curated jobs feed](/jobs), where every listing is entry-level, India-eligible, and verified from official career pages.
`,
}
