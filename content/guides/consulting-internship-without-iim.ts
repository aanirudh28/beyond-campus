...
export const consultingWithoutIimGuide: Guide = {
  slug: 'consulting-internship-without-an-iim',
  title: 'How to Break Into Consulting Without an IIM Tag',
  seoTitle: 'Consulting Internship Without IIM: How Tier-2/3 Students Break In',
  description:
    'Students from tier-2/3 colleges crack BCG, Bain and McKinsey every year through their knowledge teams, plus Big 4, boutiques and internal strategy roles. The full map and the exact preparation plan.',
...
3. **Excel and PowerPoint fluency.** Unsexy but decisive. Analyst work lives in these tools; our [Excel interview prep](/resources/excel-interview-prep) covers what's actually asked.
...
**Weeks 1-2: Case fundamentals.** Learn the core structures: profitability, market entry, market sizing. Free casebooks from IIM-A, IIM-B, ISB and others are the standard prep material; we host a [free casebook library](/resources/consulting) so you don't have to hunt for PDFs. Do 2 cases a day, out loud.
...
**Weeks 5-6: Outreach blitz.** Build a target list of 30 firms across MBB knowledge teams, Big 4, boutiques and internal strategy (the method is in the [off-campus playbook](/guides/how-to-get-an-off-campus-internship-in-india)). Then run the sequence: apply, cold email the same day, LinkedIn touch, follow-up on day 6. Use the [cold email templates](/guides/cold-email-to-hr-for-internship) and lead with your portfolio piece: "I did a market-entry analysis of the Indian EV-charging space; sharing it in case it's useful. I'd love to do this work for [Firm]."
...
Run it through the [free Resume Roast](/resources/resume-roast). It's calibrated to be brutal precisely about vague, unquantified bullets.
...
4. **Curated feeds.** Our [consulting jobs feed](/jobs/consulting) lists entry-level, India-eligible roles verified from official career pages, refreshed daily.

Track every application and follow-up in the [free Job Tracker](/job-tracker). Consulting processes have multiple rounds, and a dropped follow-up reads as a lack of the exact rigor they're hiring for.
...
If you want this whole path run with you, with a personalized firm list, case prep, resume rebuild and warm intros where we have them, that's exactly what the [Placement Cohort](/cohort) does.
`,
}
