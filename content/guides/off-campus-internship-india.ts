...
export const offCampusInternshipGuide: Guide = {
  slug: 'how-to-get-an-off-campus-internship-in-india',
  title: 'How to Get an Off-Campus Internship in India: The Complete Playbook',
  seoTitle: 'How to Get an Off-Campus Internship in India (2026 Playbook)',
  description:
    'The step-by-step system non-tech students from tier-2/3 colleges use to land consulting, finance and startup internships off-campus: resume, target list, cold email, LinkedIn, follow-ups.',
  category: 'PLAYBOOK',
...
Don't spend three weeks perfecting it. Get it to "strong" in a day (run it through the [free AI Resume Roast](/resources/resume-roast) for brutal, specific feedback), then move to the step that actually gets interviews: outreach.
...
- **10-15 "reach" companies:** known brands in your domain (Big 4, top startups, MBB knowledge teams like BCG Vantage and BCN if you're aiming at [consulting](/guides/consulting-internship-without-an-iim)).
...
4. **Curated feeds.** Our [jobs feed](/jobs) lists entry-level, India-eligible business roles verified daily from official career pages, so you skip the expired links and "5 years experience required" bait.
...
Run 5 companies per day, 5 days a week. That's 25 companies a week through the full sequence and 50+ touchpoints. Most students lose track of this by day four, which is exactly why we built a [free job tracker](/job-tracker) with automatic follow-up reminders.
...
- **A small case or assignment:** consulting-style guesstimate, a marketing plan, a sales pitch. For consulting prep specifically, see [how to break into consulting without an IIM tag](/guides/consulting-internship-without-an-iim).
...
**Want the engine pre-built?** The [₹299 Career Toolkit](/resources/career-toolkit) has the proven cold email and LinkedIn templates plus Tracker Pro. And if you want us to run this whole playbook *with* you (personalized target list, resume rebuild, warm intros), that's the [Placement Cohort](/cohort).
`,
}
