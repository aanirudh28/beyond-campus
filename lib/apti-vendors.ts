...
export const VENDORS: VendorPattern[] = [
  ...
  {
    slug: 'aon-cut-e', name: 'Aon cut-e', maker: 'Aon Assessment',
    tagline: 'Short, speeded "scales" modules where a couple of errors sink you.',
    formatLine: 'Very short adaptive modules (scales numerical, scales verbal, scales logical) of roughly 6 to 12 minutes each, often using interactive drag-and-rank formats.',
    adaptive: true, negativeMarking: 'Speed-penalised',
    scoring: 'Module scales benchmarked against a norm group',
    quirks: [
      'Each module is tiny and intensely speeded, so a few careless slips can sink a whole module.',
      'Formats are interactive (rank, match, drag) rather than plain multiple choice. Practise the mechanic, not just the maths.',
      'It is adaptive, so a fast accurate streak escalates difficulty. Steady accuracy under pressure is the whole test.',
      'Consistency across modules is read as a signal. One collapsed module stands out.',
    ],
    drillSkills: ['fraction-percent-conversion', 'percentage-change', 'basic-averages', 'series-next-term', 'two-statement'],
    vendorMatch: ['cut-e', 'Aon'], confidence: 'estimated',
  },
]
