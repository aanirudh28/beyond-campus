...
import { ensureAptiProfile, getOrBuildTodaySet, loadSetQuestions, clientSafeQuestion } from '@/lib/apti'
...
export async function GET() {
  ...
  const questions = await loadSetQuestions(set.question_ids)
  ...
  return NextResponse.json({
    ...
    questions: questions.map(clientSafeQuestion),
    profile: {
