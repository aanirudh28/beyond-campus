...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      {/* phones get the icon only — the full pill buried CTAs on small screens */}
      <style>{`
        @media (max-width: 640px) {
          .wa-float { padding: 14px !important; }
      ...
      <span className="wa-label">Join our WhatsApp community</span>
    </a>
  )
}
