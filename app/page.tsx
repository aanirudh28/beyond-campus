      ...
      <section style={{ padding: '110px 24px', background: 'linear-gradient(180deg, rgba(79,124,255,0.04), transparent)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <p data-reveal style={{ color: 'var(--muted)', fontSize: 16, maxWidth: 560, lineHeight: 1.7, marginBottom: 48 }}>
            Ten free tools covering every stage of the hunt — fix the resume, clear the aptitude
          ...
          <div className="bento">
            ...
            {[
              ...
              { span: 'b2', index: '10', icon: '⏳', title: '20 Years in 60 Minutes', badge: 'JUST DROPPED', badgeColor: '#f0abfc', desc: 'A career life-simulator. Live from final year to 45 in 35 choices and meet one of 27 endings. Which one are you headed for?', href: '/20years', cta: 'Live my 20 years →' },
            ].map((tool, i) => (
